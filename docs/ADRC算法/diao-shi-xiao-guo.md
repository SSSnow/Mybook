...
俯仰通道扫频
从横滚和俯仰内环的幅频特性图可以看出。扫频的频率范围为2-35rad/s（0.3-5.5Hz）。从图中可以看出，在2-30rad/s的频率范围内，几乎无超调，截止频率大约在25rad/s。相频特性曲线从0度逐渐下降到-180，说明延迟在逐渐增大。穿越频率大约在23rad/s。从截止频率和穿越频率两个指标来看，内环的响应速度很快，且无超调。
